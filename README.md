...
- **[WCLAP gallery ▶](https://pulp-wclap-demos.pages.dev/example-plugins/)** — the
...
**[WAM vs WCLAP: how the web demos are built](web/WAM-vs-WCLAP.md)** for
the full, evenhanded comparison. Each row has a separate **▶ WAM** and **▶ WCLAP**
column; either link opens that plugin's "click to start" page.
